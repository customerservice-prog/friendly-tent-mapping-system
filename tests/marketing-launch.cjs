...
const webVitals=fs.readFileSync(path.join(root,'web-vitals.js'),'utf8');
...
assert.match(marketingJs,/analytics-loader\.js\?v=20260922-ga4-2/);
assert.match(designerHtml,/analytics-loader\.js\?v=20260922-ga4-2/);
...
assert.match(designerHtml,/web-vitals\.js\?v=20260922-rum-2/);
assert.match(webVitals,/api\/analytics\/web-vitals/);
assert.match(webVitals,/navigator\.webdriver === true/);
assert.match(webVitals,/version: 2/);
assert.match(webVitals,/location\.pathname/);
assert.match(webVitals,/largest-contentful-paint/);
assert.match(webVitals,/layout-shift/);
assert.match(webVitals,/durationThreshold: 40/);
assert.doesNotMatch(webVitals,/location\.search|location\.hash|localStorage|customerEmail|designId|recoveryToken/);
assert.match(privacyHtml,/Analytics and performance/);
assert.match(privacyHtml,/Google Analytics/);
assert.match(privacyHtml,/Largest Contentful Paint \(LCP\)/);
...
assert.match(marketingJs,/var isHomepage = location\.pathname === '\/' \|\| location\.pathname === '\/index\\.html'/,'homepage skips live plan hydration on critical load');
