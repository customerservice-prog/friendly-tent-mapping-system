...
assert.match(inventorySoftware,/<title>Party Rental Inventory Software Guide/);
...
assert.match(managementSoftware,/<title>Party Rental Management Software Guide/);
