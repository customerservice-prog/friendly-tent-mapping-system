...
test('photo rotation preserves the original local dimensions of a legacy accessory',()=>{
  ...
  const result=evaluatePropertyScene({backgroundPhoto:'photo',photoSite:site,tent:{...site,isSite:true},objects:[item],photoCalibration:{autoEstimated:false,scaleConfirmed:true,frontLeft:{x:.1,y:.9},frontRight:{x:.9,y:.9},backRight:{x:.7,y:.5},backLeft:{x:.3,y:.5}},photoGeometry:[{id:'boundary',type:'fence',x:0,y:49,widthFt:50,depthFt:.1}]});
