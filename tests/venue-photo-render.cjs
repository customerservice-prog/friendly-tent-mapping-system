...
(async()=>{
 ...
 dom.window.close();
 console.log('PASS venue photo renderer: Matched View, photo-derived 360 World, eye-level first-person Walk Mode, panorama and parallax all remain reversible.');
