...
const VISUAL_LIBRARY = [
  ...
  { id: 'crossback-natural', category: 'chair', name: 'Cross-Back Farmhouse Chair', silhouette: 'crossback', dimensionsConfirmed: false, dimensionsNote: 'Photo-referenced wood chair; seat, footprint and back-height dimensions are illustrative.' },
  ...
  { id: 'banquet-6ft', category: 'table', name: "6 Foot Banquet Table", silhouette: 'banquet-rect', dimensionsConfirmed:false, dimensionsNote:'6-foot length is reported in the product name; depth, height and setup clearance are illustrative.' },
  { id: 'banquet-8ft', category: 'table', name: "8 Foot Banquet Table", silhouette: 'banquet-rect' },
  { id: 'sweetheart-half-round-60', category: 'table', name: 'Sweetheart Table (60in Half-Round)', silhouette: 'sweetheart-half-round', shape:'half-round', seatingLayout:'sweetheart', dimensionsConfirmed:false, dimensionsNote:'60-inch span is reported in the product name; 30-inch depth is inferred from the half-round shape. Confirm measurements.' },
