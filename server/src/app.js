...
app.use((err,req,res,next)=>{console.error(err);if(err&&err.type==='entity.too.large')return res.status(413).json({error:'Request too large'});res.status(500).json({error:'Internal server error'});});
module.exports=app;
