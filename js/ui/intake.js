...
const noneChip = el('button', 'studio-feature-chip muted' + (wiz.features.indexOf(FEATURE_NONE) !== -1 ? ' selected' : '')); noneChip.setAttribute('aria-pressed', wiz.features.indexOf(FEATURE_NONE) !== -1 ? 'true' : 'false');
      noneChip.type = 'button';
      noneChip.appendChild(iconSvg('<circle cx="12" cy="12" r="9"/><path d="M5.6 5.6l12.8 12.8"/>'));
      noneChip.appendChild(el('span', null, 'None of These'));
      noneChip.addEventListener('click', function () { toggleFeature(FEATURE_NONE); render(); });
      grid.appendChild(noneChip);
      const notSureChip = el('button', 'studio-feature-chip muted' + (wiz.features.indexOf(FEATURE_NOT_SURE) !== -1 ? ' selected' : '')); notSureChip.setAttribute('aria-pressed', wiz.features.indexOf(FEATURE_NOT_SURE) !== -1 ? 'true' : 'false');
      notSureChip.type = 'button';
      notSureChip.appendChild(iconSvg('<circle cx="12" cy="12" r="9"/><path d="M9.5 9.5a2.5 2.5 0 1 1 3.5 2.3c-.8.5-1 1-1 2.2"/><path d="M12 17.5h.01"/>'));
      notSureChip.appendChild(el('span', null, 'Not Sure Yet'));
