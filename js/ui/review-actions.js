...
function bind(){
 ...
 function printNow(){if(!allowPaidAction())return;var review=$('step-review');if(review&&!review.classList.contains('active')){$('btnToReview')?.click();setTimeout(function(){window.print();},80);}else window.print();}
