...
(function () {
  ...
  function open(options) {
    ...
    root.innerHTML = '<div class="gp-shell"><header class="gp-header"><div><p class="gp-eyebrow">RentSketch · watch-only walkthrough</p><h2 id="guided-preview-title" tabindex="-1">Watch us design an event</h2></div><button type="button" class="gp-close" aria-label="Close walkthrough and return to rental preview">×</button></header>' +
      ...
      '<footer class="gp-footer"><button type="button" class="gp-buy"></button><a class="gp-booking" href="https://rentsketch.com/my-event/?tenant=friendly&mode=order">Existing order? Open for FREE</a><p><strong>Quick Demo · watch-only · replay anytime.</strong> One event access is separate; rentals are separate.</p></footer></div>';
