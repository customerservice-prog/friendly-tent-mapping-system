...
export function sitePanel(state,tent){
 ...
 return `<h3>Where is your event?</h3><p class="equipment-note">Choose the actual setup surface. Your equipment stays in place.</p>${venuePhotoPanel(state.backgroundPhoto,state.venuePhotoStatus)}<div class="site-options">${[
