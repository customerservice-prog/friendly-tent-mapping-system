  ...
  function rebuild(data){
    ...
    if(nextGhost!==ghostKey){
      ...
      if(data.placement){
        ...
        if(items[0]?.kind==='table')ghost.add(table({...items[0],x:0,y:0}));
