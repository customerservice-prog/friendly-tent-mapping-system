...
// Pole positions and installation clearance are placeholder/estimated for
// visual planning only, pending exact engineering specs from Friendly's
// install crew -- do not treat as a final installation plan. See
// js/data/tentStructure.js for the shared calculations used here.

import { computeCenterPoles, installationClearanceFt } from './tentStructure.js';
...
function poleLayoutFor(type, widthFt, lengthFt) {
        ...
        return { centerPoles: computeCenterPoles(type, widthFt, lengthFt), estimated: true };
}
...
function buildTent(id, name, type, widthFt, lengthFt, pricePerDay) {
        ...
        return {
                      ...
                      installationClearanceFt: installationClearanceFt(type),
