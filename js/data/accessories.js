...
const PROFILES=[
  ...
  {test:/bubble machine|bubble blower/,type:'bubble-machine',category:'Effects',w:2.5,d:2.5,h:2.5,animated:true},
  {test:/fog machine|smoke machine|haze machine/,type:'fog-machine',category:'Effects',w:2.5,d:2.5,h:2,animated:true},
  {test:/confetti|streamer machine/,type:'confetti-machine',category:'Effects',w:2.5,d:2.5,h:2,animated:true},
  {test:/photo ?booth|photobooth/,type:'photo-booth',category:'Entertainment',w:6,d:6,h:7,animated:true},
  {test:/karaoke/,type:'karaoke',category:'Entertainment',w:4,d:3,h:5,animated:true},
  {test:/projector|projection screen|movie screen|tv screen/,type:'screen',category:'Entertainment',w:8,d:2,h:7,animated:true},
  {test:/speaker|pa system|bluetooth/,type:'speaker',category:'Audio',w:2,d:2,h:4.5,animated:true},
  {test:/podium|lectern/,type:'podium',category:'Audio',w:2,d:2,h:4,animated:true},
  {test:/microphone|mic stand/,type:'microphone',category:'Audio',w:1,d:1,h:5,animated:true},
  ...
  {test:/cooler/,type:'cooler',category:'Service',w:3,d:2,h:2,animated:true},
  {test:/trash|garbage/,type:'trash-can',category:'Service',w:2,d:2,h:3,animated:true},
  {test:/stanchion|velvet rope|crowd control/,type:'stanchion',category:'Event Accessories',w:5,d:1.5,h:3.5,animated:true},
  {test:/red carpet|aisle runner/,type:'red-carpet',category:'Event Accessories',w:4,d:15,h:.08},
  {test:/cornhole/,type:'cornhole',category:'Games',w:8,d:12,h:1.2,animated:true},
  {test:/connect ?4|connect four/,type:'connect-four',category:'Games',w:4,d:2,h:4.5,animated:true},
  {test:/tumbling timbers|giant jenga|jenga/,type:'tumbling-blocks',category:'Games',w:4,d:4,h:5,animated:true},
  {test:/nacho|hot dog|pretzel|slush|frozen drink|coffee urn|beverage dispenser/,type:'concession',category:'Concessions',w:2.5,d:2.5,h:4,animated:true},
  ...
  {test:/bar(?!rel)|beverage station/,type:'bar',category:'Service',w:6,d:2.5,h:4,animated:true},
  {test:/fill.*chill/,type:'service-table',category:'Service',w:4,d:2.5,h:3,animated:true},
  {test:/stage section|stage deck/,type:'stage',category:'Staging',w:4,d:4,h:2,animated:true},
  ...
  {test:/arch|backdrop/,type:'backdrop',category:'Decor',w:8,d:2,h:8,animated:true},
  {test:/centerpiece/,type:'centerpiece',category:'Decor',w:2,d:2,h:3,animated:true},
];
