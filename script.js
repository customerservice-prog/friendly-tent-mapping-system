...
function setViewMode(mode){
  ...
  if($('view3dFit'))$('view3dFit').hidden=mode!=='3d';if($('view3dInside'))$('view3dInside').hidden=mode!=='3d';
  ...
  if(mode==='3d')setTimeout(function(){mount3D();},16);
